...
export type NightwatchCustomPageObjects = {};
...
// tslint:disable-next-line
export type NightwatchElement = WebElement;
...
type ElementGlobalDefinition =
	| string
	| SeleniumBy
	| RelativeBy
	| { selector: string; locateStrategy?: string }
...
// tslint:disable-next-line
export type NightwatchPosition = WindowPosition;
...
// tslint:disable-next-line
export type NightwatchSize = WindowSize;
...
export interface ChromeNsCommands<ReturnType = unknown> {
	 ...
	 * @param deviceName name of the target device.
	 */
	stopCasting(deviceName: string): Awaitable<IfUnknown<ReturnType, this>, null>;
}
