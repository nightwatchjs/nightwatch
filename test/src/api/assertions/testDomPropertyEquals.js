  ...
  it('not.domPropertyEquals assertion failed', function () {
    return assertionTest({
      ...
      assertion({instance, queueOpts, err}) {
        ...
        assert.strictEqual(err.message, 'Error while running "domPropertyEquals" command: Testing if dom property \'className\' of element <.test_element> doesn\'t equal \'visible-element\' in 5ms - expected "not visible-element" but got: "visible-element"');
      }
    });
  });
  ...
  it('domPropertyEquals assertion - element not found', function () {
    return assertionTest({
      ...
      assertion({instance, failure, err}) {
        ...
        assert.strictEqual(err.message, 'Error while running "domPropertyEquals" command: Test attribute \'className\' from element "<.test_element>" == \'visible-element\' in 5ms - expected "visible-element" but got: "element could not be located"');
      }
    });
  });
  ...
  it('domPropertyEquals assertion - dom property not found', function() {
    return assertionTest({
      ...
      assertion({instance, message, failure}) {
        assert.strictEqual(message, 'Testing if dom property \'className\' of element <.test_element> equals \'visible-element\' in 5ms - expected "visible-element" but got: "Element does not have a \'className\' dom property"');
        assert.strictEqual(instance.hasFailure(), false);
        assert.strictEqual(instance.getValue(), null);
