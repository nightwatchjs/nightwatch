...
describe('test page object element selectors with locateStrategy from nightwatch settings', () => {
  before(function() {
    nocks.enable();
  });
  ...
  it('page object allows shorthand selector for xpath when "use_xpath=true"', (done) => {
    Nightwatch.init({
      page_objects_path: [path.join(__dirname, '../../extra/pageobjects/pages')],
      custom_commands_path: [path.join(__dirname, '../../extra/commands')],
      custom_assertions_path: [path.join(__dirname, '../../extra/assertions')],
  ...
  it('page object defaults to css selector for shorthand when "use_xpath=false"', (done) => {
    Nightwatch.init({
      page_objects_path: [path.join(__dirname, '../../extra/pageobjects/pages')],
      custom_commands_path: [path.join(__dirname, '../../extra/commands')],
      custom_assertions_path: [path.join(__dirname, '../../extra/assertions')],
  ...
  describe('elements', () => {
    ...
    it('page object finds element', (done) => {
      nocks
        .elementsByXpath('//div')
        .text('0', 'first');
