...
describe('test PageObject Commands', function () {
  ...
  it('testPageObjectframe()Command', function (done) {
    MockServer.addMock({
      url: '/wd/hub/session/1352110219202/elements',
      method: 'POST',
      postdata: '{ "using": "css selector", "value": "iframe" }',
    ...
    MockServer.addMock({
      ...
      method: 'POST',
      postdata: JSON.stringify({id: {ELEMENT: '1'}}),
      response: JSON.stringify({
        sessionId: '1352110219202',
        status: 0
      })
    ...
    page.frame('@frameElement', function callback(result) {
