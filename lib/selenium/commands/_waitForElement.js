...
WaitForElement.prototype.pass = function(result, defaultMsg) {
 ...
 * @returns {string}
 */
WaitForElement.prototype.formatMessage = function (defaultMsg) {
  return format(this.message || defaultMsg, this.selector, this.ms);
};
