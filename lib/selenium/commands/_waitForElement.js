...
WaitForElement.prototype.command = function(selector, milliseconds, callbackOrAbort) {
  assertMilliseconds.call(this, milliseconds);
  ...
  this.ms = milliseconds || this.client.api.globals.waitForConditionTimeout;
 ...
 * @returns {number}
 */
function assertMilliseconds(timeoutMs) {
  var globalTimeout = this.client.api.globals.waitForConditionTimeout;

  if (!timeoutMs && typeof globalTimeout !== 'number') {
