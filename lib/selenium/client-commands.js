module.exports = function(client) {
  return {
    ...
    /**
     * This command is a utility command to be used only on [AngularJS](http://angularjs.org/) enabled web applications.
     *
     * #### AngularJS
     * AngularJS is a very powerful and comprehensive MVC-based framework for building web applications and websites.
     *
     *
     * #### ngMock
     * The `ngMock` module providers support to inject and mock Angular services into unit tests.
     * Similarly, support for mock services to be used in E2E tests is provided by the `ngMockE2E` module.
     *
     *
     * #### ngMockE2E
     * The `ngMockE2E` module allows defining of http request interceptors (mocks) issued by the Angular application using the `$http` module. This allows isolating the test to only the client-side part and removes the dependency on the backend services.
     *
     * Read more about the `ngMockE2E` module on [AngularJS documentation site](http://docs.angularjs.org/api/ngMockE2E)
     *
     * ### Overview
     * This utility command simplifies the creation and maintenance of mock service definitions by removing their declaration from the main app's module.
     *
     * Nightwatch creates a separate module (with the `.E2E` suffix added to your main module) and declares all the mock services inside it.
     *
     * @method initNgMockApp
     * @param {string} mainUrl
     * @param {object} opts
     * @param {function} mocks
     * @param {Array} passThrough
     * @api commands
     * @since v0.4.0
     */
    initNgMockApp : function(mainUrl, opts, mocks, passThrough) {
      var addDeferBootstrap = function(mainUrl) {/*! jshint browser:true */return (function(w){w.name='NG_DEFER_BOOTSTRAP!'+w.name;location.href=mainUrl;})(window);};
      ...
      var bootstrapFn = 'var passedArgs = Array.prototype.slice.call(arguments,0);' +
        ...
        'angular.module(app+".E2E",[app,"ngMockE2E"])' +
          '.run(function($httpBackend) {' +
            ...
            '}' +
          '});' +
        'document.documentElement.setAttribute("ng-app", app+".E2E");' +
        'angular.bootstrap(document.documentElement, [app+".E2E"]);' +
      '}).apply(null, passedArgs)';

      return this.url('about:blank', function() {
        this.execute(addDeferBootstrap, [mainUrl], function() {
