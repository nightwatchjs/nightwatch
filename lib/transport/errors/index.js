...
const Errors = {
  ...
  [ErrorCode.NO_SUCH_ELEMENT]: {
    ...
    link: 'https://nightwatchjs.org/guide/debugging/errors#nosuchelementexception'
  },
  ...
  [ErrorCode.NO_SUCH_FRAME]: {
    ...
    link: 'https://nightwatchjs.org/guide/debugging/errors#nosuchframeexception'
  },
...
module.exports = {
  ...
  getErrorObject(seleniumErrorCode){
    if (seleniumErrorCode in SeleniumNightwatchErrorCodeMap){
      const statusCode = SeleniumNightwatchErrorCodeMap[seleniumErrorCode];
