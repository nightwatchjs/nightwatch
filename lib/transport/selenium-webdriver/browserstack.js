...
class Browserstack extends Selenium {
  ...
  constructor(nightwatchInstance, browserName) {
    var bstackOptions = {};
    Object.assign(bstackOptions, nightwatchInstance.settings.desiredCapabilities['bstack:options']);
    if (!(Object.prototype.hasOwnProperty.call(bstackOptions, 'buildName'))) {
      bstackOptions['buildName'] = 'nightwatch-test-build';
      Object.assign(nightwatchInstance.settings.desiredCapabilities['bstack:options'], bstackOptions);
    }
