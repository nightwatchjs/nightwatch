...
class Browserstack extends BaseDriver {
  ...
  adaptSettings() {
    ...
    if(this.settings.browserstackLocal) {
      this.settings.desiredCapabilities['bstack:options'].local = true;
      (this.settings.browserstackLocal.localIdentifier && this.settings.browserstackLocal.localIdentifier != "undefined") && 
        (this.settings.desiredCapabilities['bstack:options'].localIdentifier = this.settings.browserstackLocal.localIdentifier);
    }
