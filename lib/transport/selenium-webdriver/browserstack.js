...
class Browserstack extends BaseDriver {
  ...
  adaptSettings() {
    ...
    if(this.settings.local_setup) {
      this.settings.desiredCapabilities['bstack:options'].local = true;
      (this.settings.local_setup.localIdentifier && this.settings.local_setup.localIdentifier != "undefined") && 
        (this.settings.desiredCapabilities['bstack:options'].localIdentifier = this.settings.local_setup.localIdentifier);
    }
