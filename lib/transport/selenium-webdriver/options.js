const {exclude} = require('../../settings/defaults');
...
module.exports = class Options {
  ...
  static createChromeOptions(settings) {
    ...
    if (webdriver.detach_driver || settings.detach_driver) {
      options.detachDriver(webdriver.detach_driver||settings.detach_driver);
    }
