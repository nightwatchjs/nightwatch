  ...
  get methods() {
    return {
      ...
      session: {
        ...
        async maximizeWindow(_windowHandle) {
        ...
        async setWindowPosition(_windowHandle, x, y) {
        ...
        async locateMultipleElementsByElementId({id, _using, value}) {
          const locator = SeleniumWebdriver.createLocator(value);
          const element = await this.getWebElement(id);
        ...
        async uploadFile(webElementId, filepath) {
          const remote = require('selenium-webdriver/remote');
          this.driver.setFileDetector(new remote.FileDetector);
        
          try {
            const element = this.getWebElement(webElementId);
        ...
        /**
         *
         * @param {WebElement|null|undefined} element
         * @param {{async: (boolean|undefined), bridge: (boolean|undefined)}} options
         */
        async doubleClick(element, options) {

          await this.driver.actions(options).doubleClick(element);
         ...
         * @param {{async: (boolean|undefined), bridge: (boolean|undefined)}} options
         */
        async mouseButtonClick(element, options) {
          await this.driver.actions(options).click(element);
         ...
         * @param {Origin|WebElement|undefined} origin
