    ...
    return {
      ...
      session: {
        ...
        async clearElementValue(webElementOrId) {
          ...
          // Get the value of the element after clearing it
          const value = await element.getAttribute('value');

          // If the value is not empty, send backspace key presses until it's cleared
          while (value !== '') {
            await element.sendKeys('\u0008'); // Unicode character for backspace
