  ...
  get methods() {
    return {
      ...
      session: {
        ...
        async sendKeysToElement(webElementOrId, value, force = false) {
          if (Array.isArray(value)) {
          ...
          if (!force) {
            ...
            // If force is enabled, use the Actions API and try to send keys.
        ...
        async clickElement(webElementOrId, force = false) {
          const element = this.getWebElement(webElementOrId);
        ...
        async scrollElement(webElementOrId, direction, amount) {
