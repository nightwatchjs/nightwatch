        ...
        async clearElementValue(webElementOrId, text) {
          try {
            ...
            while (value !== null && value !== '') {
              await element.sendKeys(Key.BACK_SPACE); // Send BACK_SPACE keys to clear the value
              value = await element.getAttribute('value'); // Update the value after sending BACK_SPACE
            }
