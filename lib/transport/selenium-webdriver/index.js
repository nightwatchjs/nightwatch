...
class Transport extends BaseTransport {
  ...
  async createSession({argv, moduleKey}) {
    ...
    await this.showConnectInfo({startTime, host, portStr, start_process, sessionInfo});
  ...
  // Output related
  ////////////////////////////////////////////////////////////////////
  async showConnectInfo({startTime, portStr, host, start_process, sessionInfo}) {
    this.showConnectSpinner(`Connected to ${colors.stack_trace(start_process ? this.serviceName : host)} on ${portStr} ${colors.stack_trace('(' + (new Date() - startTime) + 'ms)')}.`);
