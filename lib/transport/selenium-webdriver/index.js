        ...
        if (binaryLocation === '') {
          ...
          if (err.message.includes('no devices online')) {
            help =  [
              ...
              `If testing on emulator, check the Nightwatch configuration to make sure ${colors.cyan('real_mobile')} is set to ${colors.cyan('false')} and ${colors.cyan('avd')} to the name of AVD to launch and test on.`
            ];
          }
        }
