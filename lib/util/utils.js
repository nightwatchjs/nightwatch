...
class Utils {
  ...
  /**
   * Run several promises concurrently
   *
  ...
  static runPromises(promises) {
    ...
    return Utils.processAsyncQueue(Utils.MAX_CONCURRENT_PROMISES, promises, function(promise, index, next) {
  ...
  /**
   * Collects all unqouted arguments in an array of arugments and returns them.
