...
module.exports = class Utils {
   ...
   * @return {Function}
   */
  static setCallbackTimeout(done, fnName, timeMs, onTimeoutExpired = function() {}, onTimerStarted = function() {}) {
  ...
  static processAsyncQueue(concurrency, files, cb) {
  ...
  static showStackTrace(stack) {
    ...
    if (parts.length > 0) {
      ...
      console.error(Logger.colors.stack_trace(result.replace(indentRegex, '   ')));
    }
  }
