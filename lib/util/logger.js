...
function ConsoleColor() {
  ...
  Object.keys(this.foreground_colors).forEach(function(k) {
    ConsoleColor.prototype[k.toLowerCase()] = function Foreground(text, background) {
      var foreground = self.foreground_colors[k.toLowerCase()];
      if (Settings.simple) {
        foreground = foreground.slice(2); // remove intensity
      }
      var string = '\033[' + foreground + 'm';
...
exports.useSimpleColors = function() {
