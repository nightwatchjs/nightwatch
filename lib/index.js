...
function WebdriverJs(options) {
  ...
  this.options.output = options.output || typeof (options.output) == 'undefined';      
...
util.inherits(WebdriverJs, events.EventEmitter);

WebdriverJs.prototype.start = function() {
  if (!this.sessionId) {
...
WebdriverJs.prototype.terminate = function() {
  var self = this;
...
WebdriverJs.prototype.printResult = function() {
...
WebdriverJs.prototype.loadProtocolActions = function() {
...
WebdriverJs.prototype.loadCommands = function() {
  require('./selenium/commands.js').addCommands.call(this);
  return this;
}

WebdriverJs.prototype.loadCustomCommands = function() {
...
WebdriverJs.prototype.loadAssertions = function() {
  var self = this;
...
WebdriverJs.prototype.addVerifyTests = function() {
  this.verify = {};
  this.loadAssetionFiles(this.verify, false);
  return this;
}

WebdriverJs.prototype.loadAssetionFiles = function(parent, abortOnFailure) {
...
WebdriverJs.prototype.addCommand = function(name, command, context, parent) {
  parent = parent || this;
  if (parent[name]) {
    this.results.errors++;
 ...
 */
WebdriverJs.prototype.runProtocolCommand = function(requestOptions, callback) {
  var self = this;
...
WebdriverJs.prototype.runCommand = function(commandName, args, callback) {
  var self = this;
...
WebdriverJs.prototype.executeCommand = function(command) {
...
WebdriverJs.prototype.getElement = function(using, value, callback) {
  var self = this;
...
WebdriverJs.prototype.assertion = function(passed, receivedValue, expectedValue, message, abortOnFailure) {
...
WebdriverJs.prototype.saveScreenshotToFile = function(fileName, content) {
...
WebdriverJs.prototype.handleTestError = function(result) {
  var errorMessage = '';
...
WebdriverJs.prototype.startSession = function() {
  var self = this;
...
exports.remote = function(options, settings) {
  return new WebdriverJs(options, settings);
}
