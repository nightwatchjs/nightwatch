...
Nightwatch.prototype.handleException = function(err) {
  ...
  if (err.generatedMessage && typeof err.actual != 'undefined' && typeof err.expected != 'undefined') {
    firstLine += '\033[0m - expected ' + Logger.colors.green('"' + err.expected + '"') + ' but got: ' + Logger.colors.red(err.actual);
  }
