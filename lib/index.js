...
const {By, Key, Capabilities, Browser} = require('selenium-webdriver');
...
Nightwatch.createClient = function({
  ...
  return {
    runner_options: {
      ...client.settings.test_runner.options
    },
    setCapabilites(capabilities) {
      Object.assign(client.settings.desiredCapabilities, capabilities);
    },
    session() {
