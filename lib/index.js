...
const namespacedApi = require('./namespaced-api');
...
// Named exports
module.exports.browser = namespacedApi.browser;
module.exports.app = namespacedApi.app;

module.exports.appium = namespacedApi.appium;
module.exports.alerts = namespacedApi.alerts;
module.exports.cookies = namespacedApi.cookies;
module.exports.document = namespacedApi.document;
module.exports.window = namespacedApi.window;

module.exports.chrome = namespacedApi.chrome;
module.exports.firefox = namespacedApi.firefox;

module.exports.assert = new Proxy(namespacedApi.assert, {
  get(_, name) {
    return namespacedApi.assert[name];
  }
});
module.exports.verify = new Proxy(namespacedApi.verify, {
  get(_, name) {
    return namespacedApi.verify[name];
  }
});
module.exports.expect = new Proxy(namespacedApi.expect, {
  apply(_, __, args) {
    throwIfBrowserNotAvailable();
...
module.exports.element = new Proxy(namespacedApi.element, {
  apply(_, __, args) {
    throwIfBrowserNotAvailable();
