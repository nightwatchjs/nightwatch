...
class Nightwatch extends EventEmitter {
  ...
  get screenshotsEnabled() {
    return typeof this.options.screenshots == 'object' ? this.options.screenshots && this.options.screenshots.enabled === true : false
  }
  ...
  shouldPersistGlobals() {
    return this.options.persist_globals === true;
  }
  ...
  setGlobals() {
    if (this.shouldPersistGlobals()) {
      this.setApiProperty('globals', this.options.globals);
    }
  ...
  setHttpOptions() {
    this.options.webdriver = this.options.webdriver || {};
...
const Exports = module.exports = {
   ...
   */
  initClient(opts) {
    const Manager = require('./runner/client-manager.js');
