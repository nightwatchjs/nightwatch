  ...
  const exported = {
    ...
    launchBrowser() {
      ...
      return client.initialize()
        ...
        .then((data) => {
          console.info('Nightwatch session created...');
          if (this.settings.test_runner?.type === 'cucumber' && NightwatchEventHub.isAvailable) {
            console.info('Session and capabilities being sent to parent process');
        ...
        .catch((error) => {
          console.info('Error while creating Nightwatch session:', error);
          if (this.settings.test_runner?.type === 'cucumber' && NightwatchEventHub.isAvailable) {
            console.info('Session error being sent to parent process');
            const NightwatchFormatter = require('./runner/test-runners/cucumber/nightwatch-format');
