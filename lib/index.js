...
const Assertion = require('./core/assertion.js');
...
class Nightwatch extends events.EventEmitter {
  ...
  setWebdriverOptions() {
    this
      .deprecateSeleniumSetting('host', ['seleniumHost', 'selenium_host'], {allowEmpty: true, defaultValue: 'localhost'})
      .deprecateSeleniumSetting('port', ['seleniumPort', 'selenium_port'], {allowEmpty: true, defaultValue: 4444})
      .deprecateSeleniumSetting('ssl', ['useSsl', 'use_ssl'], {defaultValue: false})
      .deprecateSeleniumSetting('proxy', 'proxy')
      .deprecateSeleniumSetting('timeout_options', 'request_timeout_options')
      .deprecateSeleniumSetting('default_path_prefix', 'default_path_prefix')
      .deprecateSeleniumSetting('username', 'username')
      .deprecateSeleniumSetting('access_key', 'access_key')
      .deprecateSeleniumSetting('access_key', ['accessKey', 'access_key', 'password']);

    HttpRequest.setOptions(this.options.webdriver);
  }

  deprecateSeleniumSetting(newSetting, oldSetting, opts = {}) {
