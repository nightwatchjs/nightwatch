...
Nightwatch.prototype.handleException = function(err) {
  ...
  if (typeof err.actual != 'undefined' && typeof err.expected != 'undefined') {
    firstLine += '\0' + '33[0;90m - expected ' + Logger.colors.green('"' + err.expected + '"') + ' \0' + '33[0;90mbut got: ' + Logger.colors.red('"' + err.actual + '"');
  }
...
exports.runner = function(argv, done, settings) {
  var runner = exports.CliRunner(argv); // eslint-disable-line new-cap
