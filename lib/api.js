...
module.exports = new (function() {
  ...
  var BaseAssertion = function (abortOnFailure, client) {
  ...
  function construct(constructor, args, superclass, superclassargs) {
    function F() {
  ...
  var AssertionFactory = function(assertionFn, abortOnFailure, client) {
    function Instance(abortOnFailure, client) {
      BaseAssertion.call(this, abortOnFailure, client);
    }

    Instance.prototype._commandFn = function() {
      var args = Array.prototype.slice.call(arguments, 0);
      var instance = construct(assertionFn, args, BaseAssertion, [abortOnFailure, client]);
      ...
      methods.forEach(function(method) {
        ...
        } else if (typeof instance[method] == 'undefined') {
    ...
    return new Instance(abortOnFailure, client);
  };
  ...
  function createAssertion(commandName, assertionFn, abortOnFailure, parent) {
    ...
    if (typeof assertionFn === 'object' && assertionFn.assertion) {
      assertion = AssertionFactory(assertionFn.assertion, abortOnFailure, client);
    ...
    assertion = new Assertion(abortOnFailure, client);
  ...
  function addCommand(name, command, context, parent, resetQueue) {
    ...
    parent[name] = (function(internalCommandName) {
      return function() {
        ...
        CommandQueue.add(internalCommandName, command, context, args, resetQueue);
