...
module.exports = new (function() {
  ...
  const ExpectDefinitionsPath = path.join(__dirname, '../api/expect.js');
  ...
  function loadExpectAssertions(nightwatchInstance) {
    const Expect = require(ExpectDefinitionsPath)(nightwatchInstance);
    let assertions  = Object.keys(Expect);
return
