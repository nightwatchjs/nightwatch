const { ScopedValue } = require('../element/scoped-value.js');
...
class ScopedElementAssertions {
  ...
  hasClass(name, message = `Tesing if the element has "${name}" class.`) {
...
exports.ScopedElementAssertions = ScopedElementAssertions;
