...
module.exports = class NightwatchInspectorServer extends WebSocket {
   ...
   */
  addExtensionInChromeOption(settings) {
    ...
    if (settings && 
      ...
      typeof settings.globals.settings === 'object' &&
      settings.globals.settings.desiredCapabilities !== undefined
    ) {
      settings.globals.settings.desiredCapabilities = desiredCapabilities;
    }
  }
