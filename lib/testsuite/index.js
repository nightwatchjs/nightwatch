...
class TestSuite {
  ...
  isScreenshotEnabled() {
    return this.api.options.screenshots.enabled;
  }

  shouldTakeScreenshotOnError() {
    return this.isScreenshotEnabled() && this.api.options.screenshots.on_error;
  }

  shouldTakeScreenshotOnFailure() {
    return this.isScreenshotEnabled() && this.api.options.screenshots.on_failure;
  }
  ...
  async handleRunnable(name, fn) {
    try {
      ...
      if (!isAssertionError(err)) {
        ...
        if(this.api.sessionId && this.shouldTakeScreenshotOnError()) {
      ...
      if(this.api.sessionId && this.shouldTakeScreenshotOnFailure()) {
        await this.takeScreenshot();
      }
