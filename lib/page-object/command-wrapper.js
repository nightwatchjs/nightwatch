...
class Command {
  ...
  parseElementSelector(args) {
    ...
    if (inputElement && inputElement.hasElementSelector()) {
      ...
      const strategy = Utils.isObject(possibleElementSelector) && possibleElementSelector.locateStrategy || null;
      const elementOrSection = getter.call(this, inputElement.selector, strategy);
