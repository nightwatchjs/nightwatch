...
module.exports = new (function() {
  ...
  function getElement(parent, elementName) {
    if (elementName.indexOf('@') !== 0) {
      throw new Error('Element name declared on a page object must be precedeed by \'@\'.');
    }
  ...
  function makeWrappedCommand(parent, commandFn, commandName, isChaiAssertion) {
    return function() {
      ...
      if (isElementAssertion(commandName)) {
        var firstArg;
        var desiredStrategy;
  ...
  function isElementAssertion(commandName) {
    return getNonElementAssertions().indexOf(commandName) <= -1;
  }
