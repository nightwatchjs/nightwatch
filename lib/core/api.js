...
module.exports = new (function() {
  ...
  var throwOnConflictingCommands;
  var assertOperators = {
    ok : ['ok', 'ko'],
    equal : ['==', '!='],
    notEqual : ['!=', '=='],
  ...
  function addCommand(name, command, context, parent) {
    parent = parent || client.api;
    if (parent[name] && throwOnConflictingCommands) {
  ...
  this.init = function(c) {
    ...
    throwOnConflictingCommands = c.options.throwOnConflictingCommands !== false && globals.throwOnConflictingCommands !== false;
    return this;
  };
