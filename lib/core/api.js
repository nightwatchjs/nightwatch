...
module.exports = new (function() {
  ...
  function loadAllCommands(parent) {
    ...
    loadElementCommandFiles(client.api, parent);
    loadClientCommandFiles(client.api, parent);
  }
  ...
  /**
   * Loads the external element commands
   */
  function loadElementCommandFiles(context, parent) {
    parent = parent || client.api;
    var relativePath = './../api/element-commands/';
    loadCommandFiles(relativePath, context, parent);
  }

  /**
   * Loads the external client commands
   */
  function loadClientCommandFiles(context, parent) {
    parent = parent || client.api;
    var relativePath = './../api/client-commands/';
    loadCommandFiles(relativePath, context, parent);
  }

  /**
   * Loads external commands
   */
  function loadCommandFiles(relativePath, context, parent) {
  ...
  function addPageObject(name, pageFnOrObject, context, parent) {
    parent[name] = function() {
      ...
      if (typeof pageFnOrObject == 'object' && (pageFnOrObject.elements || pageFnOrObject.sections)) {
