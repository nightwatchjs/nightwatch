...
const SelectorPlaygroundServer = require('../testsuite/browser-playground/playground-listener.js');
...
class NightwatchClient extends EventEmitter {
  ...
  get selectorPlaygroundServer() {
    return this.__playgroundServer;
  }
  ...
  async attachPlaygroundExtension() {
    this.__playgroundServer = new SelectorPlaygroundServer(this);

    if(this.__playgroundServer.chromeOption()) {
      this.__playgroundServer.initSocket();
      await this.__playgroundServer.createExtension();
    }
