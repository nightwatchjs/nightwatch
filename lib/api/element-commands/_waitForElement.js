...
WaitForElement.prototype.checkElement = function() {
  var self = this;
  this.getProtocolCommand()(this.locateStrategy, this.selector, function(result) {
...
WaitForElement.prototype.getProtocolCommand = function() {
  if (this.locateStrategy == 'recursion') {
    return require('./_elementsByRecursion.js')(this.client);
  }

  return this.protocol.elements;
};
