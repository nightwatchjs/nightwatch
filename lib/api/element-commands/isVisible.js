...
/**
 * Determine if an element is currently displayed. Starting with `v1.2` you can suppress element not found errors, in case the element is not found on the page, by specifying the `supressNotFoundErrors` flag.
 *
 * @example
