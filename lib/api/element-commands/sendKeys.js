 ...
 *
 * <div class="alert alert-warning"><strong>sendKeys</strong> does not clear the existing value of the element. If you wish to do that use the <strong>setValue()</strong> command instead.</div>
 *
