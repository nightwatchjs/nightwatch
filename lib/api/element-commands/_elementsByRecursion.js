...
module.exports = function(client) {
  ...
  function deferredElementIdElements(el, using, value) {
    ...
    Protocol.elementIdElements(el, using, value, function(result) {
   ...
   * @api protocol
   */
  function elementsByRecursion(using, elements, callback) {
    ...
    Protocol.elements(topElement.locateStrategy, topElement.selector, checkResult);
  }
