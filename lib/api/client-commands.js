  ...
  return {
    ...
    saveScreenshot : function(fileName, callback) {
      ...
      if( client.api.options.use_screenshot_path ) {
        var rootPath = client.api.options.screenshots.path;
        resolvedPath = path.join(rootPath, resolvedPath);
      }

      return this.screenshot(client.api.options.log_screenshot_data, function(result) {
        client.saveScreenshotToFile(resolvedPath, result.value, function(err) {
          if (typeof callback === 'function') {
