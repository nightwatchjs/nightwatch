...
BaseAssertion.prototype.init = function() {
  this.promise  = flag(this.assertion, 'promise');
  this.element  = flag(this.assertion, 'element');
  this.selector = flag(this.assertion, 'selector');
...
BaseAssertion.prototype.processFlags = function() {
  BaseAssertion.ASSERT_FLAGS.forEach(function(entry) {
    var value = flag(this.assertion, entry);
...
BaseAssertion.prototype['@equalFlag'] = function(value) {
  var verb = (this.hasFlag('that') || this.hasFlag('which')) ? 'equals' : 'equal to';
  this.conditionFlag(value, function() {
...
BaseAssertion.prototype.setNegate = function() {
  this.negate = flag(this.assertion, 'negate') || false;
  return this;
};
...
BaseAssertion.prototype.checkWaitForMsg = function(waitFor) {
  var preposition = flag(this.assertion, 'before') && 'in' ||
    flag(this.assertion, 'after') && 'after' ||
    'in';
