 ...
 *      browser.expect.element('body').to.have.attribute('data-attr').equal.to('some attribute');
 *      browser.expect.element('body').to.have.attribute('data-attr').which.contains('some attribute');
 *      browser.expect.element('body').to.have.attribute('data-attr').which.matches(/some\ attribute/);
 *    };
 * ```
 *
 * @constructor
