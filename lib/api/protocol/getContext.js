 ...
 * @example
 * module.exports = {
 *   'get current context': function (client) {
 *     client.getContext(function (result) {
 *       console.log('the current context is:', result.value);
 *     });
 *   },
 *
 *   'get current context with ES6 async/await': async function (client) {
 *     const context = await client.getContext();
 *     console.log('the current context is:', context);
 *   }
 * };
 *
 * @syntax .getContext([callback])
 * @method getContext
