...
// module.exports = class FindElementWithChildText  extends ProtocolAction {
//   async command(...args) {
//     let text; let exactMatch;

//     if (args.length === 2 && Utils.isString(args[1])) {
//       text = args.pop();
//     } else if (args.length === 3 && Utils.isFunction(args[2])) {
//       [text] = args.splice(1, 1);
//     } else if (args.length === 4 || (args.length === 3 && Utils.isObject(args[2]))) {
...
//       const textContent = await webElement.getAttribute('textContent');
