module.exports = function(Nightwatch) {
  ...
  // Helpers
  /////////////////////////////////////////////////////////////////////////////
  Actions.elementsCommand = function(using, selector, callback) {
    if (using == 'recursion') {
      return require('./element-commands/_elementsByRecursion.js')(Nightwatch)(selector, callback);
    }

    return Actions.elements(using, selector, callback);
  };
