...
module.exports = class ProtocolActions {
  ...
  get Actions() {
    return {
       ...
       */
      element(using, value, callback = function() {}) {
       ...
       * @api protocol.elements
       */
      elements(using, value, callback = function() {}) {
       ...
       * @api protocol.elements
       */
      elementIdElement(id, using, value, callback = function() {}) {
        ...
        return this.findElements({
          id, using, value, commandName, callback
        });
      },
       ...
       *
       * @link
       * @param {string} id The web element ID assigned to the element to move to. If not specified or is null, the offset is relative to current position of the mouse.
      ...
      moveTo(id, xoffset, yoffset, callback) {
        return this.TransportActions.moveTo(id, xoffset, yoffset, callback);
      },
   ...
   * @return {Promise}
   */
  findElements({id, using, value, commandName, callback}) {
    const element = Element.createFromSelector(value, using);
