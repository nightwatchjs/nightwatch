const elementByRecursion = require('./element-commands/_elementByRecursion.js');
const elementsByRecursion = require('./element-commands/_elementsByRecursion.js');
...
module.exports = function(nightwatchInstance) {
  ...
  const Protocol = new Proxy(nightwatchInstance.transport.Actions, {
    get(target, name) {
      return function(...args) {
        let callback = args.pop();

        return target[name](...args).on('result', result => {
          callback(result);
        })
      };
    }
  ...
  Actions.session = function(action, sessionId, callback) {
    if (!(action in SessionActions)) {
      throw new Error(`Invalid or unsupported http verb passed to .session(): ${action}. ` +
        `It should be one of: ${Object.keys(SessionActions).join(', ')}.`);
    }
    ...
    return Protocol.session(action.toUpperCase(), sessionId, callback);
  };
  ...
  Actions.sessions  = function(callback) {
    return Protocol.getSessions(callback);
  };
  ...
  Actions.timeouts  = function(type, ms, callback) {
    ...
    return Protocol.setTimeoutType(type, ms, callback);
  };
  ...
  Actions.timeoutsAsyncScript  = function(ms, callback) {
    ...
    return Protocol.setTimeoutsAsyncScript(ms, callback);
  };
  ...
  Actions.timeoutsImplicitWait  = function(ms, callback) {
    ...
    return Protocol.setTimeoutsImplicitWait(ms, callback);
  };
  ...
  Actions.status = function(callback) {
    return Protocol.getStatus(callback);
  };
  ...
  Actions.sessionLog = function(typeString, callback) {
    return Protocol.getLogContents(typeString, callback);
  };
  ...
  Actions.sessionLogTypes = function(callback) {
    return Protocol.getSessionLogTypes(callback);
  };
  ...
  Actions.url = function(url, callback) {
    if (typeof url == 'string') {
      return Protocol.navigateTo(url, callback);
    }

    return Protocol.getCurrentUrl('/url', arguments[0]);
  };
  ...
  Actions.back = function(callback) {
    return Protocol.navigateBack(callback);
  };
  ...
  Actions.forward = function(callback) {
    return Protocol.navigateForward(callback);
  };
  ...
  Actions.refresh = function(callback) {
    return Protocol.pageRefresh(callback);
  };
  ...
  Actions.title = function(callback) {
    return Protocol.getPageTitle(callback);
  };
  ...
  Actions.window = function(method, handleOrName, callback) {
    ...
    switch (method) {
      case 'POST':
        ...
        return Protocol.switchToWindow(handleOrName, callback);

      case 'DELETE':
        return Protocol.closeWindow(arguments[1]);
  ...
  Actions.windowHandle =  function(callback) {
    return Protocol.getWindowHandle(callback);
  };
  ...
  Actions.windowHandles = function(callback) {
    return Protocol.getAllWindowHandles(callback);
  };
  ...
  Actions.windowPosition = function(windowHandle, offsetX, offsetY, callback) {
    ...
    if (arguments.length === 2 && typeof arguments[1] === 'function') {
      return Protocol.getWindowPosition(windowHandle, arguments[1]);
    }
    ...
    return Protocol.setWindowPosition(windowHandle, offsetX, offsetY, callback);
  };
  ...
  Actions.windowSize = function(windowHandle, width, height, callback) {
    ...
    if (arguments.length === 2 && typeof arguments[1] === 'function') {
      return Protocol.getWindowSize(windowHandle, arguments[1]);
    }
    ...
    return Protocol.setWindowSize(windowHandle, width, height, callback);
  };
  ...
  Actions.frame = function(frameId, callback) {
    if (arguments.length === 1 && typeof frameId === 'function') {
      callback = frameId;
      return Protocol.switchToFrame(callback);
    }

    return Protocol.switchToFrame(frameId, callback);
  };
  ...
  Actions.element = function(using, value, callback) {
    ...
    if (elem.locateStrategy == 'recursion') {
      return new elementByRecursion(nightwatchInstance).command(elem.selector, callback);
    }
  ...
  Actions.elements = function(using, value, callback) {
    var elem = Element.fromSelector(value, using);
    if (elem.locateStrategy == 'recursion') {
      return new elementsByRecursion(nightwatchInstance).command(elem.selector, callback);
    }
  ...
  Actions.mouseButtonDown = function(button, callback) {
    return mouseButtonHandler(Direction.DOWN, button, callback);
  };
  ...
  Actions.mouseButtonUp = function(button, callback) {
    return mouseButtonHandler(Direction.UP, button, callback);
  };
  ...
  Actions.screenshot = function(log_screenshot_data, callback) {
    return getRequest('/screenshot', callback).on('complete', function(result) {
      result = result || {};
  ...
  */
  ...
  function getSessionId() {
    return nightwatchInstance.session.sessionId;
  }

  function getRequest(path, callback) {
    var options = {
      path : '/session/' + nightwatchInstance.sessionId + path,
      method : 'GET'
    };
  ...
  function sendRequest(options, callback) {
    ...
    return nightwatchInstance.runProtocolAction(options, callback).send();
  }

  function runProtocolAction(promise, callback = function() {}) {
