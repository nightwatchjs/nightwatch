...
module.exports = function(Nightwatch) {
   ...
   * @api protocol
   */
  Actions.touchDown = function(x, y, callback) {
    return postRequest('/touch/down', {
      x: parseInt(x),
      y: parseInt(y)
    }, callback);
  };
   ...
   * @api protocol
   */
  Actions.touchMove = function(x, y, callback) {
    return postRequest('/touch/move', {
      x: parseInt(x),
      y: parseInt(y)
    }, callback);
  };
   ...
   * @api protocol
   */
  Actions.touchUp = function(x, y, callback) {
    return postRequest('/touch/up', {
      x: parseInt(x),
      y: parseInt(y)
    }, callback);
  };
