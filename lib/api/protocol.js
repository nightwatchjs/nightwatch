const SingleElementRecursiveLookup = require('./element-commands/_elementByRecursion.js');
...
module.exports = function(nightwatchInstance) {
  ...
  Actions.element = function(using, value, callback) {
    ...
    if (elem.usingRecursion) {
      return new SingleElementRecursiveLookup(nightwatchInstance).command(elem.selector, callback);
    }
