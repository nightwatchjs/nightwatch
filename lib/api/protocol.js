module.exports = function(Nightwatch) {
  ...
  Actions.element = function(using, value, callback) {
    if (using == 'recursion') {
      return require('./element-commands/_elementByRecursion.js')(Nightwatch)(value, callback);
    }
  ...
  Actions.elements = function(using, value, callback) {
    if (using == 'recursion') {
      return require('./element-commands/_elementsByRecursion.js')(Nightwatch)(value, callback);
    }
