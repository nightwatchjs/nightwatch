...
module.exports = function(Nightwatch) {
   ...
   * Sets desired context
   */
  Actions.context = function(method, callbackOrContext){
    switch (method){
      case 'GET' :
        return getRequest('/context', callbackOrContext);
      case 'POST' :
        return postRequest('/context', {name : callbackOrContext}, arguments[2]);
      default :
        throw new Error('This method should have an argument GET or POST.');
    }
  };
