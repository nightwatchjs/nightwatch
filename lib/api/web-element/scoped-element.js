...
class ScopedWebElement {
  ...
  runQueuedCommand(commandName, {args = [], namespace, isRoot = false, isTerminal = false, name} = {}) {
    ...
    return this.waitFor(node.deferred.promise, {isRoot, isTerminal});
  }
