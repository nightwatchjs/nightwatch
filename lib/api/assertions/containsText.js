...
exports.assertion = function(selector, expectedText, msg) {
  ...
  this.message = msg || util.format('Testing if element <%s> contains text: "%s".', this.elementSelector, expectedText);
  ...
  this.failure = function(result) {
    ...
    if (failed) {
      this.message = msg || util.format(MSG_ELEMENT_NOT_FOUND, this.elementSelector, expectedText);
    }
