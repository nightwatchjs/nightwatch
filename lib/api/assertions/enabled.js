 ...
 *   browser.assert.elementEnabled('.should_be_enabled');
 *   browser.assert.elementEnabled({selector: '.should_be_enabled'});
 *   browser.assert.elementEnabled({selector: '.should_be_enabled', suppressNotFoundErrors: true});
 * };
 * ```
 *
 * @method enabled
...
exports.assertion = function(definition, msg) {
  ...
  this.command = function(callback) {
    this.api.getElementProperty(definition, 'disabled', callback);
  };
