...
exports.assertion = function(selector, className, msg) {
  const MSG_ELEMENT_NOT_FOUND = 'Testing if element <%s> has css class: "%s". ' +
    'Element could not be located.';

  this.message = msg || util.format('Testing if element <%s> has css class: "%s".', this.elementSelector, className);
