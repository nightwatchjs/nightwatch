...
exports.assertion = function(selector, expected, msg) {
  ...
  this.message = msg || util.format('Testing if value of <%s> equals: "%s".', this.elementSelector, expected);
  ...
  this.failure = function(result) {
    ...
    if (failed) {
      this.message = msg || util.format(MSG_ELEMENT_NOT_FOUND, this.elementSelector, expected);
    }
