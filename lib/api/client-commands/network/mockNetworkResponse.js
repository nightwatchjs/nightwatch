 ...
 *      browser
 *        .network.mockNetworkResponse('https://www.google.com/', {
 *          status: 200,
 *          headers: {
 *            'Content-Type': 'UTF-8'
 *          },
 ...
 *  });
 *
 * @method network.mockNetworkResponse
 * @syntax .network.mockNetworkResponse(urlToIntercept, {status, headers, body}, [callback])
