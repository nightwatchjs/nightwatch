...
Debug.prototype.command = function(config, cb) {
  ...
  //const always_async_commands = this.client.settings.always_async_commands;
  const always_async_commands = this.client.isES6AsyncTestcase;
  //this.client.settings.always_async_commands = true;
  ...
  repl.onExit(() => {
    ...
    //this.client.settings.always_async_commands = always_async_commands;
    this.client.isES6AsyncTestcase = always_async_commands;
