...
class AssertionScheduler {
  ...
  createAssertionRunner({passed, actual, commandCallback, message, elapsedTime, extraData}) {
  ...
  schedule() {
    this.instance.command(function commandCallback(commandResult, commandInstance) {
      ...
      this.createAssertionRunner({passed, actual, commandCallback, message, elapsedTime, extraData: this.instance.extraData});
