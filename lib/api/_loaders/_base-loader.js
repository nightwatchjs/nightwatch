...
class BaseLoader extends EventEmitter {
  ...
  get disableTs(){
    return this.nightwatchInstance.settings.disable_typescript === true;
  }
  ...
  requireModule(fullPath, fileName) {
    if (!Utils.isFileNameValid(fileName) 
        || (fileName.startsWith('_') && this.ignoreUnderscoreLeadingNames)
        || (Utils.isTsFile(fileName) && this.disableTs())) {
      return this;
    }
