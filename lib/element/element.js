...
class Element {
  ...
  setProperties(definition, options) {
    ...
    if (!Utils.isUndefined(definition.supressNotFoundErrors)) {
      this.supressNotFoundErrors = Utils.convertBoolean(definition.supressNotFoundErrors);
    }
