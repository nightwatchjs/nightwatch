...
class LocateElement {
   ...
   * }})
   */
  executeProtocolAction(element, transportAction, protocolCommand) {
    return this.transport.executeProtocolAction(transportAction, [element.locateStrategy, element.selector])
      .then(result => {
