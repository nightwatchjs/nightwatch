...
const {Logger, PeriodicPromise} = Utils;
...
class ElementCommand extends EventEmitter {
  ...
  async findElement({returnSingleElement = true} = {}) {
    ...
    try {
      ...
      return await this.elementLocator.findElement({element, commandName, returnSingleElement});
    } catch (err) {
