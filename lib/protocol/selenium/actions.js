...
class ProtocolActions {
  ...
  static sendRequest(options) {
    if (typeof options == 'string') {
      options = ProtocolActions.createOptions(options);
    }

    return ProtocolActions.transport.runProtocolAction(options);
  }
}

module.exports = {
  elementApiMappings: ProtocolActions.elementApiMappings
};

Object.keys(ProtocolActions.methodMappings).forEach(function(name) {
  module.exports[name] = function(definition) {
    let args = definition.args;
    let mapping = ProtocolActions.methodMappings[name];
    ...
    return ProtocolActions.sendRequest(requestOptions);
  };
});
