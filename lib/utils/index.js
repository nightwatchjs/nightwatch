...
class Utils {
  ...
  static isSimulator(desiredCapabilities) {
  ...
  static isRealIos(desiredCapabilities) {
    const {browserName = '', platformName = ''} = desiredCapabilities;
  ...
  static isAndroid(desiredCapabilities) {
  ...
  static isMobile (desiredCapabilities) {
    if (Utils.isSimulator(desiredCapabilities) || Utils.isRealIos(desiredCapabilities) || Utils.isAndroid(desiredCapabilities)) {
      return true;
    }
