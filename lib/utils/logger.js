...
const Logger = {
  ...
  setHttpLogOptions({showRequestData, showResponseHeaders}) {
    Settings.showRequestData = showRequestData;
    Settings.showResponseHeaders = showResponseHeaders;
  },

  showRequestData() {
    return Settings.showRequestData;
  },

  showResponseHeaders() {
    return Settings.showResponseHeaders;
  },
