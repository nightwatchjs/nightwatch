...
class Settings {
  ...
  inheritFromDefaultEnv() {
    ...
    if (this.testEnv === 'browserstack'){
      var bstackOptions = {};
      Object.assign(bstackOptions, testEnvSettings.desiredCapabilities['bstack:options']);
      if (!(Object.prototype.hasOwnProperty.call(bstackOptions, 'buildName'))) {
        bstackOptions['buildName'] = 'nightwatch-test-build';
        Object.assign(testEnvSettings.desiredCapabilities['bstack:options'], bstackOptions);
      }
    }
