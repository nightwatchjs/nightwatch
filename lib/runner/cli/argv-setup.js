  ...
  class ArgvSetup {
    ...
    setup() {
      ...
      */
      ...
      this.option('workers', {
        description: 'Specify the number of worker processes to be used for running the tests in parallel; e.g. workers=4'
      });

      // $ nightwatch --sequential
      this.option('sequential', {
        description: 'Executes tests sequentially (disables parallel mode)'
      });
