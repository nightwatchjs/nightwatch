...
const {Logger, singleSourceFile, iosRealDeviceUUID} = Utils;
...
class CliRunner {
  ...
  initTestSettings(userSettings = {}, baseSettings = null, argv = null, testEnv = '') {
    ...
    if (argv.uuid && browserName.toLowerCase() === 'safari' && platformName.toLowerCase() === 'ios' && desiredCapabilities['safari:useSimulator'] !== true) {
      this.test_settings.desiredCapabilities['safari:deviceUUID'] = iosRealDeviceUUID(argv.uuid);
    }
