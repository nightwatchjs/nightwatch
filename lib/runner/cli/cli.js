...
const {Logger, singleSourceFile, iosRealDeviceUDID, isRealIos, isSimulator, isAndroid} = Utils;
...
class CliRunner {
  ...
  initTestSettings(userSettings = {}, baseSettings = null, argv = null, testEnv = '') {
    ...
    if (this.argv.parallel && (isSimulator(desiredCapabilities) || isRealIos(desiredCapabilities) || isAndroid(desiredCapabilities))) {
