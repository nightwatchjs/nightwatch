...
const {Logger, singleSourceFile, iosRealDeviceUDID, isRealIos, isMobile} = Utils;
...
class CliRunner {
  ...
  initTestSettings(userSettings = {}, baseSettings = null, argv = null, testEnv = '') {
    ...
    if (this.argv.parallel && isMobile(desiredCapabilities)) {
      let err = new Error('Parallel mode is not suported for iOS/Android');
      err.stack = false;
