...
class CliRunner {
  ...
  commonSetup(settings) {
    ...
    analyticsCollector.event('on_cli_invoke', {
      arg_env: this.argv.env,
      arg_parallel: this.argv.parallel !== undefined ? this.argv.parallel : 'undefined',
      ...
      test_runner: JSON.stringify(this.test_settings.test_runner)
    });
