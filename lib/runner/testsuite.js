...
TestSuite.prototype.setCurrentTest = function(testRetries) {
  ...
  this.client.api('currentTest', {
    ...
    testMaxRetries: this.testMaxRetries,
    suiteRetries: this.suiteRetries,
    suiteMaxRetries: this.suiteMaxRetries
  });
  return this;
};
...
TestSuite.prototype.runTestCase = function(currentTest, deffered, numRetries) {
  var self = this;
  this.setCurrentTest(numRetries);
