...
TestCase.prototype.catchHandler = function(err) {
  // This reports fewer failures
  // return this.setFailed(err);
  // Show exceptions in errors list
  this.suite.client.errors().push(err.stack);

  // These have no effect:
  // this.stackTrace = err.stack;
  // this.errmessages = err.stack;
  // this.currentDeferred.reject(error);

  // This doesnt work
  // this.suite.client.addError(err.message, err.stack);
