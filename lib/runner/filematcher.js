...
var debug = require('debug')('nightwatch:filematcher');
  ...
  tags: {
    ...
    match : function (testFilePath, opts) {
      ...
      try {
        ...
        // failed to load
          debug('Failed to load file: ' + testFilePath + ' Error: ' + e);
          console.error(Logger.colors.red(String.fromCharCode(10006) + ' Failed to load file: ' + testFilePath + ' Error: ' + e + '\n'));
        return false;
      }
