  ...
  tags: {
    ...
    checkModuleTags: function (test, opts) {
      ...
      if (!Array.isArray(moduleTags)) {
        return typeof opts.tag_filter == 'undefined' && typeof opts.tags_filter == 'undefined' && typeof opts.skiptags != 'undefined';
      }
      ...
      if (opts.tag_filter || opts.tags_filter || opts.skiptags){
        ...
        if (opts.tags_filter) {
          match = this.containsAllTags(moduleTags, this.convertTagsToString(opts.tags_filter));
        }
    ...
    containsAllTags : function(moduleTags, tags) {
