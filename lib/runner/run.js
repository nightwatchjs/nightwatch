...
module.exports = new (function() {
  ...
  function runModule(module, opts, moduleName, moduleCallback, finishCallback) {
    ...
    var onTestFinished = function (results, errors, startTime) {
      ...
      globalResults.passed += testResults.passed += results.passed;
      globalResults.failed += testResults.failed += results.failed;
      globalResults.errors += testResults.errors += results.errors;
      globalResults.skipped += testResults.skipped += results.skipped;
      globalResults.tests += testResults.tests += results.tests.length;
  ...
  this.run = function runner(files, opts, additional_opts, finishCallback) {
    ...
    runFiles(paths, function runTestModule(err, fullpaths) {
      opts.modulesNo = fullpaths.length;
