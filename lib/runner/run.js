...
module.exports = new (function() {
  ...
  this.run = function runner(test_source, opts, additional_opts, finishCallback) {
    ...
    runFiles(paths, function runTestModule(err, fullpaths) {
      ...
      var runGlobalBeforeEach = !module.disabled && opts.globals && opts.globals.beforeEach || noopFn;
      var runGlobalAfterEach = !module.disabled && opts.globals && opts.globals.afterEach || noopFn;
      var globalReporter = opts.globals && opts.globals.reporter || noopFn;
