...
module.exports = new (function() {
  ...
  function makeAsync(asyncArgCount, fn) {
    if (fn.length === asyncArgCount) { return fn; }
    function asyncFn() {
      var args = [];
  ...
  this.run = function runner(test_source, opts, additional_opts, finishCallback) {
    ...
    runFiles(paths, function runTestModule(err, fullpaths) {
      ...
      var runGlobalBeforeEach = !module.disabled && opts.globals && opts.globals.beforeEach || function() {};
      var runGlobalAfterEach = !module.disabled && opts.globals && opts.globals.afterEach || function() {};
      var globalReporter = opts.globals && opts.globals.reporter || function() {};
