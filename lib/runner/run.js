...
module.exports = new(function() {
  ...
  var postTestModuleCallback = function(err, modulekeys, fullpaths) {
  ...
  function runTestModule(err, fullpaths) {
    ...
    runGlobalBeforeEach.call(globalOpts.globals, function() {
      runModule(module, globalOpts, moduleName, moduleKey, function(err, modulekeys) {
        postTestModuleCallback(err, modulekeys, fullpaths);
      }, globalFinishCallback);
    });
  }
  ...
  var run = function runner(test_source, opts, additional_opts, finishCallback) {
    ...
    runFiles(globalPaths, runTestModule, opts);
  ...
  this.moduleCallback = postTestModuleCallback;
